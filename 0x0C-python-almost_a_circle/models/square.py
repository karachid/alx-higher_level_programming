...
class Square(Rectangle):
    ...
    @property
    def size(self):
        """Get the size of a Square instance"""
        return self.width

    @size.setter
    def size(self, value):
        """Set the size of a Square instance"""
        self.width = value
        self.height = value

    def __str__(self):
        """Returns a new representation of a Square"""
        return "[Square] ({}) {}/{} - {}".format(self.id, self.x, self.y,
                                                 self.width)

    def update(self, *args, **kwargs):
        """Updates props of a Square instance
        Args:
            *args (ints): New attributes vals
